...
public class AgentInfo {
    ...
    private String kdagent;
    private String dmspecia;
    ...
    public void setKdagent(String kdagent) {
        this.kdagent = kdagent;
    }

    public void setDmspecia(String dmspecia) {
    ...
    public String getKdagent() {
        return kdagent;
    }

    public String getDmspecia() {
        return dmspecia;
    }
